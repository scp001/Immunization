...
//@interface ImmunizationObject : NSObject
//@end

@interface ImmunizationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ImmunizationObject class]])
		{
			for (NSString *key in [[(ImmunizationObject*)o modules] allKeys])
			{
