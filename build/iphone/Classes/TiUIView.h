...
/**
 Base class for all Immunization views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Immunization view hierarchy (such as wrapped iOS UIViews) was touched.
