...
// in simulator we redefine to format for Immunization Developer console
...
{\
	NSString * exceptionName = [@"org.immunization." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.immunization";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIImmunizationNativeItemNone = -1, 
	UIImmunizationNativeItemSpinner = -2,
	UIImmunizationNativeItemProgressBar = -3,
	
	UIImmunizationNativeItemSlider = -4,
	UIImmunizationNativeItemSwitch = -5,
	UIImmunizationNativeItemMultiButton = -6,
	UIImmunizationNativeItemSegmented = -7,
	
	UIImmunizationNativeItemTextView = -8,
	UIImmunizationNativeItemTextField = -9,
	UIImmunizationNativeItemSearchBar = -10,
	
	UIImmunizationNativeItemPicker = -11,
	UIImmunizationNativeItemDatePicker = -12,
	
	UIImmunizationNativeItemInfoLight = -13,
	UIImmunizationNativeItemInfoDark = -14,
	
	UIImmunizationNativeItemDisclosure = -15,
	
	UIImmunizationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Immunization instances of
