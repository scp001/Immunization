...
@interface ImmunizationObject : KrollCoverageObject {
#else
@interface ImmunizationObject : KrollObject {
#endif
@private
...
extern NSString * Immunization$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ImmunizationObject *_immunization;
    KrollObject* console;
	BOOL shutdown;
