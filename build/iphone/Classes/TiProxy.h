...
//Rare exceptions to indicate a bug in the _immunization code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Immunization proxies.
 */
